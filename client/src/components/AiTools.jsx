    ...
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto'>
            {AiToolsData.map((tool,index)=>(
                <div key={index} className='p-8 rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col' onClick={()=> user && navigate(tool.path)}>
